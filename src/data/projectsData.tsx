...
export const flagWorld: ProjectProps = {
    ...
    title: "Flag World",
    introText: "Home page shows a list all countries in the world with several relevant information such region, capital and so on.Country page shows detail information of the country." 
};
